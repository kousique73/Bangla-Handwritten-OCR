...
def trainer(config):
    ...
    source_path_train = os.path.join('data', 'Train', 'Images')
    gt_path_train = os.path.join('data', 'Train', 'Annotations')
    source_path_val = os.path.join('data', 'Validation', 'Images')
    gt_path_val = os.path.join('data', 'Validation', 'Annotations')
    checkpoint_path = os.path.join('Saved Checkpoints', f'{model_name}.pth')
    tokenizer_path = os.path.join('Outputs', 'tokenizer.pk')
    logs = os.path.join('Outputs', f'train_logs_{model_name}.txt')
    charset_path = os.path.join('charset', 'printable1.txt')
    punctuations_path = os.path.join('charset', 'printable2.txt')
    ...
    output.close()
    os.rename(logs, os.path.join('Outputs', f'train_logs_{model_name}.txt'))
    plot_path = os.path.join('Outputs', f'train_plots_{model_name}.jpg')
